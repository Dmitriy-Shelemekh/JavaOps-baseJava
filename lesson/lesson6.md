...
- Рефакторинг: в конструктор main.java.modeljava.Resume добавить второй параметр `fullName`
- Сделать рефакторинг всех реализаций `Storage`: заменить метод `main.java.modeljava.Resume[] getAll()` на `List<main.java.Resumedel.Resume> getAllSorted()`
