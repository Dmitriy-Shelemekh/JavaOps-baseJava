...
> Правка к видео: main.java.storageva.ArrayStorage.delete() - вместо `main.java.storage[i] = null` нужно `main.java.storage[size-1] = null`

- Прочитать <a href="http://www.intuit.ru/studies/courses/16/16/lecture/27113?page=4">Соглашения по именованию.</a>
- Реализовать `main.java.ArrayStoragerayStorage.update`
- Сделать проверки: в `update/delete/get` - резюме есть в main.java.storage, в `save`- нет в main.java.storage: `System.out.println("main.java.modeljava.Resume ...")`.
- Сделать в save проверку на переполнениеe: `System.out.println("...")`.
- Избавится от дублирования в коде `main.java.ArrayStoragerayStorage`
